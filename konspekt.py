...
''' застосування кешування з метою збереження ресурсів'''
...
# @decorator_name                   # функція задекорована (викликається декоратором)
# @prefix_decorator_name            # функція задекорована (викликається декоратором)
